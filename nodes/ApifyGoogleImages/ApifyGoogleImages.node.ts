...
import { properties } from './ApifyGoogleImages.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'bvAQMqCbp6wE53JzK' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-images-api' as string;
export const CLASS_NAME = 'ApifyGoogleImages' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-images-app' as string;

export const DISPLAY_NAME = 'Google Images' as string;
export const DESCRIPTION =
	'Search Google Images and return image URLs, thumbnails, sources, and dimensions' as string;

export class ApifyGoogleImages implements INodeType {
